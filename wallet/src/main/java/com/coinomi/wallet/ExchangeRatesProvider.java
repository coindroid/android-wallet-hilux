...
public class ExchangeRatesProvider extends ContentProvider {
    ...
    private static final String BASE_URL = "https://ticker.coindroid.org/simple";
    ...
    private static final String COINOMI_SOURCE = "coindroid.org";
